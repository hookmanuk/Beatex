    ...
    public class Modular3DTextEditor : Editor
    {
        ...
        void MainSettings()
        {
            ...
            if (showMainSettings)
            {
                ...
                EditorGUILayout.PropertyField(combineMeshInEditor, new GUIContent("Single mesh", "In Editor" +
                    "There is no reason to turn this on for playmode unless you really need this for something. \nOtherwise, wasted resource on combining" +
                ...
                TextStyles();
                myTarget.layoutStyle = EditorGUILayout.Popup(myTarget.layoutStyle, layoutOptions, EditorStyles.popup, GUILayout.MinWidth(45));
        ...
        private void DontCombineInEditorEither()
        {
            if (!myTarget.combineMeshInEditor && PrefabUtility.IsPartOfPrefabInstance(myTarget.gameObject))
            {
                ...
                EditorGUILayout.LabelField(helpIcon, warning, GUILayout.MaxWidth(35));
